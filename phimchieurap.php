...
<head>
    ...
    <title>phim-hay/phim-chieu-rap</title>
</head>
<body>
    <div class="navbar">
      <div class="logo">
      ...
      <div class="menu">
        ...
        <a href="#" class="active">PHIM CHIẾU RẠP</a>
        ...
        <div class="content">
          ...
          <div class="list-movie">
            ...
            <div class="movie-card">
              <span class="label-top">Vietsub</span>
              <div class="movie-img">
                <img src="./img/movie21.jpg" alt="phim19" />
                <div class="btn-play">▶</div>
              </div>
              <p>LÀM GIÀU VỚI MA</p>
            </div>
            <div class="movie-card">
              <span class="label-top">Vietsub</span>
              <div class="movie-img">
                <img src="./img/movie22.jpg" alt="phim20" />
                <div class="btn-play">▶</div>
              </div>
              <p>LỐI THOÁT TRÊN KHÔNG</p>
            </div>
            <div class="movie-card">
              <span class="label-top">Vietsub</span>
              <div class="movie-img">
                <img src="./img/movie23.jpg" alt="phim19" />
                <div class="btn-play">▶</div>
              </div>
              <p>NHÀ BÀ NỮ</p>
            </div>
            <div class="movie-card">
              <span class="label-top">Vietsub</span>
              <div class="movie-img">
                <img src="./img/movie24.jpg" alt="phim20" />
                <div class="btn-play">▶</div>
              </div>
              <p>MƯA ĐỎ</p>
            </div>
            <div class="movie-card">
              <span class="label-top">Vietsub</span>
              <div class="movie-img">
                <img src="./img/movie25.jpg" alt="phim20" />
                <div class="btn-play">▶</div>
              </div>
              <p>BỐ GIÀ</p>
            </div>

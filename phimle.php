    ...
    <div class="content">
      ...
      <div class="list-movie">
        <div class="movie-card">
          ...
          <div class="movie-img">
            <img src="./img/movie39.webp" alt="phim20" />
        ...
        <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie40.webp" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>TRÀ</p>
        </div>
        <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie41.webp" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>CỔ MÁY CHIẾN TRANH</p>
        </div>
        <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie42.webp" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>NHIỆM VỤ BẤT KHẢ THI</p>
        </div>
        <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie43.webp" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>WHISTLE</p>
        </div>
        <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie44.webp" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>TRUY BẮT HUNG THỦ</p>
        </div>
        <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie11.webp" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>BÉ GHỆ MA CƯNG</p>
        </div>
        <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie13.webp" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>MAI LAN PHƯỢNG</p>
        </div>
        <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie45.webp" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>VALENTINE'S DAY</p>
        </div>
         <div class="movie-card">
          <span class="label-top">Vietsub</span>
          <div class="movie-img">
            <img src="./img/movie46.jpg" alt="phim20" />
            <div class="btn-play">▶</div>
          </div>
          <p>KHÔNG CÒN CHÚNG TA</p>
        </div>
      </div>
    </div>
    </div>
